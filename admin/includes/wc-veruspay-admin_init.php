...
if ( $this->mode == 'daemon' ) {
    ...
    $wc_veruspay_init_mode = array(
        ...
        'mode_stat' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['1'][1] .'<span style="color: #0bf;cursor: pointer;display: inline-block;width: 25px;text-align: center;border-radius: 50%;border: 1px solid #6c6c6c;height: 25px;position: relative;line-height: 22px;font-weight: lighter;">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
