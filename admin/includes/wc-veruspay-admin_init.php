...
if ( $this->mode == 'daemon' ) {
    ...
    $wc_veruspay_init_mode = array(
        ...
        'mode_stat' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['1'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_1' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_2' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['2'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_2' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_3' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['3'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_3' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_4' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['4'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_4' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_5' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['5'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_5' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_6' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['6'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_6' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
        ...
        'daemon_stat_7' => array(
            'title' => __( 'Configured Coins: ' . $_statsArray['7'][1] .'<span class="wc_veruspay_edit_daemon" data-url="https://' . $this->get_option( 'daemon_ip_7' ) . '">+</span>', 'veruspay-verus-gateway' ),
            'type' => 'title',
            'description' => '',
